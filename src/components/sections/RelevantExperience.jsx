                ...
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="rounded-xl border border-stone-300/70 bg-[#f0e9df] p-6">
                            ...
                            <p className="text-stone-400 text-xs font-semibold uppercase tracking-[0.15em] mb-3">Featured Work</p>
                            <div className="grid grid-cols-2 gap-3">
                                <Link
                                    to="/work/acfi-project"
                                    className="group flex flex-col rounded-lg border border-stone-300/70 bg-[#e2d8cc] overflow-hidden hover:border-indigo-300 hover:shadow-sm transition-all duration-300"
                                >
                                    <div className="h-28 overflow-hidden">
                                        <img
                                            src="/CFCWebsite_optimized.webp"
                                            alt="CFC Conference Platform"
                                            className="w-full h-full object-cover"
                                        />
                                    </div>
                                    <div className="px-3 py-2 flex items-center justify-between border-t border-stone-300/50">
                                        <span className="text-stone-600 text-xs font-medium group-hover:text-stone-900 transition-colors">CFC Conference Platform</span>
                                        <span className="text-indigo-500 text-xs group-hover:text-indigo-600 transition-colors">→</span>
                                    </div>
                                </Link>
                                <div className="flex flex-col rounded-lg border border-stone-300/70 bg-[#e2d8cc] overflow-hidden">
                                    <div className="h-28 flex items-center justify-center bg-[#ddd1c2]">
                                        <div className="text-center">
                                            <div className="w-7 h-7 rounded-md bg-[#d4cab9] mx-auto mb-1.5 flex items-center justify-center">
                                    ...
                                    <div className="px-3 py-2 flex items-center justify-between border-t border-stone-300/50">
                                        <span className="text-stone-500 text-xs font-medium">Church Website</span>
