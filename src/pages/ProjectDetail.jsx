        ...
        return (
            <div className="min-h-screen bg-[#e8ddd0] flex items-center justify-center">
                <div className="text-center">
                    <p className="text-stone-500 mb-4 text-sm">Project not found.</p>
            ...
            <div className="max-w-7xl mx-auto px-8 pt-24 pb-20">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-10">
                    <div className="flex flex-col justify-center">
                        ...
                        <h1 className="text-4xl lg:text-5xl font-bold text-stone-900 mb-4 leading-tight">{project.title}</h1>
                        <p className="text-stone-600 text-base leading-relaxed mb-7">{project.summary}</p>
